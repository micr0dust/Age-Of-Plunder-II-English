scoreboard players set @e[tag=cmd] bbslvl 2
...
tellraw @p[team=blue] ["",{"text":"[Chain Mail Armor]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger bb5lvl2 set 1"}},{"text":" 30","color":"dark_red"},{"text":" 20\n-----------------","color":"gold"}]
