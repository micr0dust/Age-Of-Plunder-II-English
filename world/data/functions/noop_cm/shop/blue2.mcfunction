give @p[team=blue] spawn_egg 1 1 {EntityTag:{id:"minecraft:shulker",Color:11,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:1000}],Health:1000.0f,Tags:["blue2","building","horse"],Team:blue},CanPlaceOn:["minecraft:sea_lantern"],display:{Name:"Fortress--Blue",Lore:["1.Can produce infantry, archers, and llama-knights","2. Like the tower, it can shoot arrows ","(it will be affected by the tower upgrade)"]},ench:[{id:71,lvl:3}]}
scoreboard players remove @e[tag=cmd] bwood 120
